    ...
    return (
        <div className={`popup ${showingPopup ? 'show' : ''} select-resume-popup p-2`}>
            ...
            <div className='p-2' style={{height: "150px"}}>
                {slide === 0 && <p className='has-text-white mb-4'>Navigate to any job on LinkedIn or Indeed and check this window to see data on the job's fit for you, your resumes fit to the job, and much more!</p>}
                ...
                {slide === 2 && <p className='has-text-white mb-4'>Your account is on the basic free tier. Free users are given 3 resume ratings per day for their first 2 weeks. You can upgrade from the settings tab at any time.</p>}
