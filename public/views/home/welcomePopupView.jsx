...
export const WelcomePopupView = ({showingPopup, setShowingPopup}) => {
    return (
        <div className={`popup ${showingPopup ? 'show' : ''} select-resume-popup p-2`}>
            ...
            <p className='has-text-white mb-4'>Navigate to any job on LinkedIn and check this window to see data on the job's fit for you, your resumes fit to the job, and much more!</p>
            <button 
