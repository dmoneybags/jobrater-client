...
export const WaitingForLoginView = ({showingPopup, setShowingPopup}) => {
    return (
        <div 
        ...
        >
            ...
            <p className='has-text-white is-size-4'
                ...
                >Waiting for login completion...</p>
            <hr style={{width: "80%", marginBlockStart: "0.25em", marginBlockEnd: "0.25em"}}/>
            <p className='mb-3'>Complete the login flow in the opened webpage</p>
            ...
            >
                Click here to reopen login window
            </button>
        </div>
    )
}